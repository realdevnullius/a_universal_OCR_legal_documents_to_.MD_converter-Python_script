@echo off
REM ============================================================================
REM  Conversion WITH the legal word list, for comparison against the baseline
REM  produced by ocr-without-dict.cmd.
REM  Conversie MET de juridische woordenlijst, ter vergelijking met de basisrun
REM  van ocr-without-dict.cmd.
REM
...
if not exist "%~dp0dutch_legal_lean.words" (
    echo [CMD] ERROR: dutch_legal_lean.words not found next to this .cmd file.
    echo [CMD] That word list is the whole point of this run - stopping here.
    goto :done
)
...
set "OCR_WORDS=%~dp0dutch_legal_lean.words"
...
if not exist "%FLAG%" (
    ...
    echo [CMD] Markdown produced up to that point is already in _WITH-DICT.out -
